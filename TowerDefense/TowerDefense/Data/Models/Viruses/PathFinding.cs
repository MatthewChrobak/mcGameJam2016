namespace TowerDefense.Data.Models.Viruses
{
    public class PathFinding
    {
        public Directions[] getPath(int mapNumber) {
            switch (mapNumber) {
                case 1:
                    return new Directions[] { Directions.DOWN, Directions.DOWN, Directions.RIGHT, Directions.RIGHT, Directions.DOWN,
            ...
            Directions.RIGHT, Directions.DOWN, Directions.DOWN, Directions.DOWN, Directions.DOWN };
            }
